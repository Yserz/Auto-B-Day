 ...
 * 
 */
@Named(value = "ShowTemplateAction")
public class ShowTemplateAction extends HttpRequestActionBase {
	
	@Inject
	private GroupManager groupManager;
	
	private final static Logger LOGGER = Logger.getLogger(ShowTemplateAction.class.getName());
	
	@Override
	public void perform(HttpServletRequest req, HttpServletResponse resp) throws ServletException {
		
		System.out.println("Hello, iam the " + ShowTemplateAction.class.getName());
